...
exports.placeOrder = async (req, res) => {
  try {
    ...
    console.log("Supplier details retrieved:", {
      id: supplier.id,
      name: supplier.name,
    ...
    try {
      console.log("Attempting to update request with supplier details:", {
        requestId: id,
      ...
      console.log("Updated request with supplier details and status successfully");
      
    } catch (error) {
      console.error("Full update failed, trying status only:", error.message);
